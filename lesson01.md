...
Що значить незмінними? Значить, що вже створений рядок ми змінити не можемо. Це легко покажуть подальші приклади з рядками та кортежами. Якщо ж здається, що об'єкт однієї з перелічених даних змінився - це означає, що тепер ім'я об'єкта просто вказує на нову область у пам'яті з новим об'єктом.
