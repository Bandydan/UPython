...
Але якщо під час запису у файл програма впіймає виключення, він ніколи не буде закритий. Тому варто використовувати контекстний менеджер with: 

with open('file.txt','w') as f:
    f.write('hello') 
Що дозволяє обійти можливі виключення та робить код більш читабельним.
